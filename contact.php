            ...
            <div class="contact_information">
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 adress_cont">
                <div class="information_bottom text_align_center">
                  ...
                  <div class="info_cont">
                    <h4>Hyderabad Machinery Company</h4>
                    <p>G.G.Road, Tarasingh Market, Nanded-431601,
                     Maharashtra, India</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 adress_cont">
                <div class="information_bottom text_align_center">
                  ...
                  <div class="info_cont">
                    <h4>02462-242401/9422172003</h4>
                    <p>Mon-Sat 10:am-7:00pm</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 adress_cont">
                <div class="information_bottom text_align_center">
                  ...
                  <div class="info_cont">
                    <h4>hmc721963@rediffmail.com</h4>
                  </div>
                </div>
              </div>
            </div>
